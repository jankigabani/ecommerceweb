        ...
        <div className="flex flex-col items-center justify-center w-full">
          <div className="bg-white-A700 flex md:flex-col flex-row md:gap-5 items-center justify-end p-6 sm:px-5 w-full">
            ...
            <Img
              ...
              alt="car"
            />
            <Button className="bg-gray-800 cursor-pointer font-medium font-poppins leading-[normal] min-w-[107px] ml-8 md:ml-[0] mr-[120px] py-[13px] text-center text-lg text-white-A700">
              Login
            </Button>
          </div>
