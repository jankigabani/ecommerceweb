      ...
      <header className={props.className}>
        <div className="bg-white-A700 flex md:flex-col flex-row md:gap-5 items-center justify-center p-6 sm:px-5 w-full">
          ...
          <Img
            ...
            alt="car"
          />
          <Button className="bg-gray-800 cursor-pointer font-bold font-poppins sm:hidden leading-[normal] min-w-[107px] ml-8 md:ml-[0] py-[15px] text-center text-sm text-white-A700">
            Login
          </Button>
        </div>
      </header>
