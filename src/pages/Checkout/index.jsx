                ...
                <div className="flex flex-col items-start justify-start w-full">
                  ...
                  <div className="flex flex-col gap-5 items-start justify-start mt-[35px] w-full">
                    ...
                    <Input
                      ...
                      wrapClassName="border border-bluegray-100 border-solid flex h-[60px] w-full"
                    ></Input>
                  </div>
                  ...
                  <div className="flex md:flex-col flex-row gap-8 items-center justify-between mt-9 w-full">
                    <div className="flex md:flex-1 flex-col gap-5 items-start justify-start w-[59%] md:w-full">
                      ...
                      <SelectBox
                        className="border border-bluegray-100 border-solid leading-[normal] sm:pl-5 pl-8 py-5 text-gray-500 text-left text-lg w-full"
              ...
              <div className="flex md:flex-1 flex-col items-center justify-end pt-1.5 w-1/2 md:w-full">
                <div className="flex flex-col items-start justify-start w-full">
                  ...
                  <div className="flex sm:flex-col flex-row sm:gap-10 items-center justify-between mt-[31px] w-full">
                    <Button
                      className="border border-bluegray-100 border-solid cursor-pointer flex items-center justify-center min-w-[245px] pr-[35px] py-[35px]"
                      leftIcon={
                        <Img
                    ...
                    >
                      <div className="leading-[normal] sm:pr-5 text-gray-800 text-left text-lg">
                        Credit Card
                      </div>
                    </Button>
                    <Button
                      className="bg-gray-800 border border-bluegray-100 border-solid cursor-pointer flex items-center justify-center min-w-[245px] pr-[33px] py-[35px]"
                      leftIcon={
                    ...
                    >
                      <div className="leading-[normal] sm:pr-5 text-left text-lg text-white-A700">
                        Bank Transfer
                      </div>
                    </Button>
                    <Button
                  ...
                  <Button
                    className="common-pointer bg-gray-800 cursor-pointer font-medium h-[60px] leading-[normal] md:ml-[0] ml-[555px] mt-[75px] py-[21px] text-center text-lg text-white-A700 w-[245px]"
