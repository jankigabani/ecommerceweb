        ...
        <div className="flex flex-col items-start justify-start w-full">
          ...
          <div className="flex flex-col md:gap-10 gap-20 items-end justify-start max-w-[1632px] mt-20 mx-auto md:px-5 w-full">
                  ...
                  <div className="flex flex-1 flex-col gap-8 items-center justify-start w-full">
                    <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
                      ...
                      <div className="h-12 md:ml-[0] ml-[250px] relative w-[11%] md:w-full">
                        ...
                        <Button className="absolute border border-bluegray-100 border-solid cursor-pointer font-medium h-full inset-[0] leading-[normal] m-auto py-[15px] text-center text-gray-800 text-lg w-[171px]">
                          1
                        </Button>
                      </div>
                      <Text
            ...
            <div className="flex sm:flex-col flex-row gap-8 items-center justify-end w-[26%] md:w-full">
              ...
              <Button
                className="common-pointer bg-gray-800 cursor-pointer font-medium h-12 leading-[normal] py-[15px] text-center text-lg text-white-A700 w-[171px]"
