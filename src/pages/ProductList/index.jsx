          ...
          <div className="flex md:flex-col flex-row gap-8 items-start justify-start max-w-[1632px] mt-[70px] mx-auto md:px-5 w-full">
              ...
              <div className="flex flex-col gap-8 items-start justify-start mt-[37px] w-[68%] md:w-full">
                ...
                <div className="flex flex-col gap-6 items-start justify-start w-auto">
                  <CheckBox
                    ...
                    inputClassName="border-[3px] border-bluegray-100 border-solid h-6 mr-[5px] w-6"
                    name="AllPrice"
                    id="AllPrice"
                    label="All Price"
                  ></CheckBox>
                  <div className="flex flex-row gap-4 items-center justify-start w-[87%] md:w-full">
                    <Button className="bg-gray-800 flex h-6 items-center justify-center p-[5px] w-6">
            ...
            <div className="flex md:flex-1 flex-col gap-8 items-center justify-start w-[84%] md:w-full">
              <div className="flex sm:flex-col flex-row md:gap-10 items-start justify-between pt-0.5 w-full">
                ...
                <SelectBox
                  className="sm:flex-1 leading-[normal] pt-1 text-gray-500 text-left text-lg w-[18%] sm:w-full"
              ...
              >
                ...
                <div className="flex flex-row gap-6 items-center justify-start w-auto">
                  <Img
                    ...
                    alt="arrowleft"
                  />
                  <Button className="bg-gray-800 cursor-pointer h-[50px] leading-[normal] py-[15px] text-center text-lg text-white-A700 w-[50px]">
                    1
                  </Button>
                  <Button className="border-2 border-gray-500 border-solid cursor-pointer h-[51px] leading-[normal] py-4 text-center text-gray-500 text-lg w-[51px]">
                    2
                  </Button>
                  <Button className="border-2 border-gray-500 border-solid cursor-pointer h-[51px] leading-[normal] py-4 text-center text-gray-500 text-lg w-[51px]">
                    3
