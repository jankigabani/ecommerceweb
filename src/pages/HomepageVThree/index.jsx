          ...
          >
            <div className="bg-white-A700_82 flex flex-col items-start justify-start p-[157px] md:px-10 sm:px-5 w-full">
              <div className="flex flex-col items-start justify-start md:ml-[0] ml-[126px] w-[43%] md:w-full">
                <Button className="bg-white-A700 cursor-pointer font-medium font-poppins leading-[normal] min-w-[271px] py-4 text-2xl md:text-[22px] text-center text-gray-800 sm:text-xl">
                ...
                <Button
                  className="bg-gray-800 cursor-pointer flex h-[60px] items-center justify-center mt-20 pl-[33px] py-4 w-[245px]"
                  rightIcon={
                    <Img
            ...
            <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
              ...
              <div className="flex md:flex-1 flex-col items-center justify-start w-[32%] md:w-full">
                <div className="bg-gray-50 flex flex-col items-center justify-start pb-[55px] w-full">
                  ...
                  <Button className="bg-gray-800 cursor-pointer font-bold h-[60px] leading-[normal] mt-14 py-[21px] text-center text-lg text-white-A700 w-[200px]">
                    Add to Cart
                  </Button>
                </div>
              </div>
                ...
                <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
                  ...
                  <div className="flex md:flex-1 flex-col items-start justify-start md:ml-[0] ml-[170px] w-[24%] md:w-full">
                    ...
                    <Input
                      ...
                      className="leading-[normal] p-0 placeholder:text-bluegray-100_87 sm:pl-5 text-bluegray-100_87 text-left text-lg tracking-[0.36px] w-full"
                      wrapClassName="bg-gray-800 border border-solid border-white-A700 flex mt-[35px] pb-[17px] pl-6 pt-[22px] w-full"
                      type="email"
                      suffix={
